...
{
    internal class KeyboardHookHelpers
    {

        private static IntPtr WH_KEYBOARD_LL = (IntPtr)13;
        private static IntPtr WM_KEYDOWN = (IntPtr)0x0100;
        private static IntPtr WM_SYSKEYDOWN = (IntPtr)0x0104;
        private static IntPtr WM_KEYUP = (IntPtr) 0x0101;
        private static IntPtr WM_SYSKEYUP = (IntPtr) 0x0105;
...
//it was ok and someone listens to events
        ...
        public static void CreateHook()
        {
            ...
            _lpfn = new HookProc(KeyboardHookProc2);
            using (ProcessModule curModule = Process.GetCurrentProcess().MainModule)
                _hHook = SetWindowsHookEx((int)WH_KEYBOARD_LL, _lpfn, GetModuleHandle(curModule.ModuleName), 0); 
            if (_hHook == IntPtr.Zero) 
